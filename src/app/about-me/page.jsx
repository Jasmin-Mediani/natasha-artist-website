    ...
    <main className="h-[calc(100vh - 100px)] w-full bg-gradient-to-b from-[#F3F3F3] to-[#fff] p-[20px] lg:p-[50px] lg:mx-auto pt-[0px]">
      <section className="w-[95%] mx-auto">
        ...
        <p className="text-justify mb-3 md:mt-0 mt-8 hyphens-auto">
          ...
          Eurasia, where the Siberian forests meet the open steppe. Though we
          had no art galleries or museums in my city, we had a lot of art books
          at home. My mother would often look at them with me. She would also
          ...
          an artist, never entered my mind until much, much later, and in a very
          different place.
        </p>
        <p className="mb-3 text-justify hyphens-auto">
          It was only in my early thirties that I tried my hand at art for the
          first time. The spur was a visit to MoMa in Berlin. I had never before
          encountered modern art, and it evoked in me a powerful, visceral
          response completely new to me. I felt called. As soon I returned to
          Florence, where I was living at the time, I enrolled on an art course.
          So began my transformation. Painting and drawing became akin to
          breathing for me. They became my oasis, the place to nurture my soul,
          a fount of solace at difficult moments. I simply could not fathom how
          I had managed to exist up to then without doing art everyday, no
          matter what the circumstances. Perhaps this is what is meant by being
          reborn?
        </p>
        ...
        <p className="mt-3 text-justify hyphens-auto">
          Since becoming aware of my calling for art, I have remained true to it
          ever since. It has been of tremendous benefit to me psychologically.
          ...
          talents. This gave them the confidence to enter society and work
        ...
        <p className="mt-3 text-justify hyphens-auto">
          ...
          uniquely - suited to them to achieve their goals. This understanding
